...
export default function Dashboard() {
  ...
  const [data, loading, error, triggerFetch] = useFetch(URL + "/api/v1/wp/getAllMessages", {
    method: "GET"
  });
  ...
  useEffect(() => {
    if(data?.success){
      ...
      data?.data?.map((msgs)=>{
        console.log(msgs)
        msgLength+=msgs?.messages?.length
      })
        ...
        <main className="px-6 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-xl shadow-sm overflow-hidden p-6 relative">
              <div className="flex justify-between">
                <div>
                  ...
                  <h3 className="text-3xl font-bold mt-1 text-gray-800">{totalMessages ? totalMessages :  0}</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden p-6 relative">
              ...
              <div className="mt-4 h-1 w-full bg-gray-100 rounded-full overflow-hidden">
                <div className="h-1 bg-purple-500 rounded-full" style={{ width: '65%' }}></div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden p-6 relative">
              <div className="flex justify-between">
                <div>
                  ...
                  <h3 className="text-3xl font-bold mt-1 text-gray-800">24.8%</h3>
                  <div className="flex items-center mt-2 text-sm">
                    <TrendingUp size={14} className="text-green-500 mr-1" />
              ...
              <div className="mt-4 h-1 w-full bg-gray-100 rounded-full overflow-hidden">
                <div className="h-1 bg-green-500 rounded-full" style={{ width: '25%' }}></div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm lg:col-span-2">
              ...
              <div className="space-y-5">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm text-gray-800">
                      <span className="font-medium">Scheduled campaign</span> to 342 recipients was successfully delivered
                    </p>
                    <p className="text-xs text-gray-500 mt-1">Today, 09:42 AM</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm text-gray-800">
                      <span className="font-medium">New contacts</span> (56) were imported from CSV file
                    </p>
                    <p className="text-xs text-gray-500 mt-1">Yesterday, 04:23 PM</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm text-gray-800">
                      <span className="font-medium">Attention needed:</span> 3 messages failed to deliver due to invalid numbers
                    </p>
                    <p className="text-xs text-gray-500 mt-1">Yesterday, 02:45 PM</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm text-gray-800">
                      <span className="font-medium">Automation workflow</span> "Welcome Sequence" has been activated
                    </p>
                    <p className="text-xs text-gray-500 mt-1">May 2, 2025, 11:30 AM</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <div className="mt-6 p-4 bg-indigo-50 rounded-lg">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <h4 className="text-sm font-medium text-gray-800">Monthly Statistics</h4>
                    <p className="text-xs text-gray-500 mt-1">Your monthly report is ready</p>
                  </div>
                </div>
